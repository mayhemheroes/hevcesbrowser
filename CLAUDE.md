...
## Run Information
- Mayhem Run: mayhemheroes/hevcesbrowser/hevcesbrowser-console/10
- Git Commit: a22af709a23b1145bf50cf75b4ce3cadafdf074e
- Original Image: ghcr.io/mayhemheroes/hevcesbrowser:master
- Target Executable: Not specified
- CI URL: https://github.com:443/mayhemheroes/hevcesbrowser//actions/runs/6846988537
...
- Source code: `/rlenv/source/hevcesbrowser/`
...
- `COPY . /rlenv/source/hevcesbrowser/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/hevcesbrowser/`
...
### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/hevcesbrowser/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/hevcesbrowser/fuzz
...
- Source copy: `COPY . /rlenv/source/hevcesbrowser/`
...
- Working directory: `cd /rlenv/source/hevcesbrowser/`
- No network access
